...
TEST(TestCaseName, FileLoggerTest) {
	vector<Employee> outputList = {
		{ "08117441", Name("BMU", "MPOSXU"), PhoneNum("2703", "3153"),
		BirthDay("2001", "02", "15"), "CL3", "ADV" },
		{ "88114052", Name("NQ", "LVARW"), PhoneNum("4528", "3059"),
		BirthDay("1991", "10", "21"), "CL4", "PRO" },
		{ "17112609", Name("FB", "NTAWR"), PhoneNum("5645", "6122"),
...
TEST(TestCaseName, FileLoggerDetailTest) {
	vector<Employee> outputList = {
		...
		{ "17112609", Name("FB", "NTAWR"), PhoneNum("5645", "6122"),
		BirthDay("2005", "05", "20"), "CL4", "PRO" },
		{ "0211717", Name("SBILHUT", "LDEXRI"), PhoneNum("2814", "1699"),
		BirthDay("1995", "07", "04"), "CL4", "ADV" },
		{ "03113260", Name("HH", "LTUPF"), PhoneNum("5798", "5383"),
		BirthDay("1979", "10", "18"), "CL2", "PRO" },
		{ "08123556", Name("WN", "XV"), PhoneNum("7986", "5047"),
